 ...
 * @return {Boolean} result
 */
return function(e,t,n){return g(m(e),m(t),n)}
/*!
 * Determine if the given object has an @@iterator function.
 *
 * @param {Object} target
 * @return {Boolean} `true` if the object has an @@iterator function.
 */(e,t,o);case"DataView":return g(new Uint8Array(e.buffer),new Uint8Array(t.buffer),o);case"ArrayBuffer":return g(new Uint8Array(e),new Uint8Array(t),o);case"Set":case"Map":return b(e,t,o);default:
/*!
 ...
 * @return {Boolean} result
 */
return function(e,t,n){var o=v(e),r=v(t);if(o.length&&o.length===r.length)return o.sort(),r.sort(),!1!==g(o,r)&&
/*!
 ...
 * @return {Boolean} result
 */
function(e,t,n,o){var r=n.length;if(0===r)return!0;for(var i=0;i<r;i+=1)if(!1===d(e[n[i]],t[n[i]],o))return!1;return!0}(e,t,o,n);var i=w(e),s=w(t);if(i.length&&i.length===s.length)return i.sort(),s.sort(),g(i,s,n);return 0===o.length&&0===i.length&&0===r.length&&0===s.length}
/*!
 ...
 * @param {Mixed} value
 * @return {Boolean} result
 */(e,t,o)}}(e,t,c,n);return h(e,t,n.memoize,u),u}function b(e,t,n){if(e.size!==t.size)return!1;if(0===e.size)return!0;var o=[],r=[];return e.forEach(function(e,t){o.push([e,t])}),t.forEach(function(e,t){r.push([e,t])}),g(o.sort(),r.sort(),n)}
/*!
 ...
 */
function w(e){if(function(e){return"undefined"!=typeof Symbol&&"object"==typeof e&&void 0!==Symbol.iterator&&"function"==typeof e[Symbol.iterator]}(e))try{return m(e[Symbol.iterator]())}catch(e){return[]}return[]}
/*!
...
/*!
   * Aliases.
   */
function e(t,n){return f[n]=f[t],e}("isOk","ok")("isNotOk","notOk")("throws","throw")("throws","Throw")("isExtensible","extensible")("isNotExtensible","notExtensible")("isSealed","sealed")("isNotSealed","notSealed")("isFrozen","frozen")("isNotFrozen","notFrozen")("isEmpty","empty")("isNotEmpty","notEmpty")}},,,function(e,t,n){"use strict";e.exports=function(e,t,n){n=n||1;var o=e.indexOf(t);if(o<0)return null;var r=e.slice(o+t.length);r=r.replace(/[^0-9)]*/,"");for(var i="",s=0;s<n;s++){var a=/[^0-9]/.exec(r);a&&0<a.index&&(i+="."+r.slice(0,a.index),r=r.slice(a.index+1))}return i.slice(1)}},,,,,,,,,,,,,function(e,t,n){e.exports=n(55)},function(e,t,n){"use strict";var o=n(41),r=n(15).expect;describe("get-version",function(){it("Should return null if user agent string does not contain key",function(){r(o("ABC DEF GHI","DDD",0)).to.be.null,r(o("ABC DEF GHI","DDD",1)).to.be.null,r(o("ABC DEF GHI","DDD",2)).to.be.null}),it("Should return an empty string if there is no number after key",function(){r(o("ABC DEF GHI","DE",0)).to.equal(""),r(o("ABC DEF GHI","DE",1)).to.equal(""),r(o("ABC DEF GHI","DE",2)).to.equal("")}),it("Should return an empty string if there is number after key and `)`",function(){r(o("ABC DEF )123","DE",0)).to.equal(""),r(o("ABC DEF )123","DE",1)).to.equal(""),r(o("ABC DEF )123","DE",2)).to.equal("")}),it("Should return version number string if there are numbers after key",function(){r(o("ABC DEF 12.34.56 GHI","DE")).to.equal("12"),r(o("ABC DEF 12.34.56 GHI","DE",0)).to.equal("12"),r(o("ABC DEF 12.34.56 GHI","DE",1)).to.equal("12"),r(o("ABC DEF 12.34.56 GHI","DE",2)).to.equal("12.34"),r(o("ABC DEF 12.34.56 GHI","DE",3)).to.equal("12.34.56"),r(o("ABC DEF:12.34.56 GHI","DE")).to.equal("12"),r(o("ABC DEF:12.34.56 GHI","DE",0)).to.equal("12"),r(o("ABC DEF:12.34.56 GHI","DE",1)).to.equal("12"),r(o("ABC DEF:12.34.56 GHI","DE",2)).to.equal("12.34"),r(o("ABC DEF:12.34.56 GHI","DE",3)).to.equal("12.34.56"),r(o("ABC DEF  12.34.56 GHI","DE")).to.equal("12"),r(o("ABC DEF  12.34.56 GHI","DE",0)).to.equal("12"),r(o("ABC DEF  12.34.56 GHI","DE",1)).to.equal("12"),r(o("ABC DEF  12.34.56 GHI","DE",2)).to.equal("12.34"),r(o("ABC DEF  12.34.56 GHI","DE",3)).to.equal("12.34.56")})})}]);