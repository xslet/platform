...
*/function l(e,t,n){if(!n||i(e)||i(t))return null;var o=n.get(e);if(o){var r=o.get(t);if("boolean"==typeof r)return r}return null}
/*!
...
*/function h(e,t,n,o){if(n&&!i(e)&&!i(t)){var r=n.get(e);r?r.set(t,o):((r=new p).set(t,o),n.set(e,r))}}
/*!
 * Primary Export
...
*/function r(e,t,n){(n=n||{}).memoize=!1!==n.memoize&&(n.memoize||new p);var o=n&&n.comparator,r=l(e,t,n.memoize);if(null!==r)return r;var i=l(t,e,n.memoize);if(null!==i)return i;if(o){var s=o(e,t);if(!1===s||!0===s)return h(e,t,n.memoize,s),s;var a=y(e,t);if(null!==a)return a}var c=f(e);if(c!==f(t))return h(e,t,n.memoize,!1),!1;h(e,t,n.memoize,!0);var u=function(e,t,n,o){switch(n){case"String":case"Number":case"Boolean":case"Date":return d(e.valueOf(),t.valueOf());case"Promise":case"Symbol":case"function":case"WeakMap":case"WeakSet":case"Error":return e===t;case"Arguments":case"Int8Array":case"Uint8Array":case"Uint8ClampedArray":case"Int16Array":case"Uint16Array":case"Int32Array":case"Uint32Array":case"Float32Array":case"Float64Array":case"Array":return w(e,t,o);case"RegExp":
/*!
 ...
 * @return {Boolean} result
 */
return function(e,t,n){return w(m(e),m(t),n)}
/*!
 * Determine if the given object has an @@iterator function.
 *
 * @param {Object} target
 * @return {Boolean} `true` if the object has an @@iterator function.
 */(e,t,o);case"DataView":return w(new Uint8Array(e.buffer),new Uint8Array(t.buffer),o);case"ArrayBuffer":return w(new Uint8Array(e),new Uint8Array(t),o);case"Set":case"Map":return b(e,t,o);default:
/*!
 ...
 * @return {Boolean} result
 */
return function(e,t,n){var o=v(e),r=v(t);if(o.length&&o.length===r.length)return o.sort(),r.sort(),!1!==w(o,r)&&
/*!
 ...
 * @return {Boolean} result
 */
function(e,t,n,o){var r=n.length;if(0===r)return!0;for(var i=0;i<r;i+=1)if(!1===d(e[n[i]],t[n[i]],o))return!1;return!0}(e,t,o,n);var i=g(e),s=g(t);if(i.length&&i.length===s.length)return i.sort(),s.sort(),w(i,s,n);return 0===o.length&&0===i.length&&0===r.length&&0===s.length}
/*!
 ...
 * @param {Mixed} value
 * @return {Boolean} result
 */(e,t,o)}}(e,t,c,n);return h(e,t,n.memoize,u),u}function b(e,t,n){if(e.size!==t.size)return!1;if(0===e.size)return!0;var o=[],r=[];return e.forEach(function(e,t){o.push([e,t])}),t.forEach(function(e,t){r.push([e,t])}),w(o.sort(),r.sort(),n)}
/*!
 ...
 * @param {Object} [options] (Optional)
 * @return {Boolean} result
 */function w(e,t,n){var o=e.length;if(o!==t.length)return!1;if(0===o)return!0;for(var r=-1;++r<o;)if(!1===d(e[r],t[r],n))return!1;return!0}
/*!
 ...
 */function v(e){var t=[];for(var n in e)t.push(n);return t}function i(e){return null===e||"object"!=typeof e}e.exports=d,e.exports.MemoizeMap=p},function(e,t,n){
/*!
 ...
 * Module dependencies
 */
var i=n(5),s=n(1),a=n(0),c=n(6),u=n(2),f="function"==typeof Object.setPrototypeOf,p=Object.getOwnPropertyNames(o).filter(function(e){var t=Object.getOwnPropertyDescriptor(o,e);return"object"!=typeof t||!t.configurable}),l=Function.prototype.call,h=Function.prototype.apply;e.exports=function(o,t,e,n){"function"!=typeof n&&(n=function(){});var r={method:e,chainingBehavior:n};o.__methods||(o.__methods={}),o.__methods[t]=r,Object.defineProperty(o,t,{get:function(){r.chainingBehavior.call(this);var n=function(){a(this,"lockSsfi")||a(this,"ssfi",n);var e=r.method.apply(this,arguments);if(void 0!==e)return e;var t=new s.Assertion;return u(this,t),t};if(i(n,t,!0),f){var e=Object.create(this);e.call=l,e.apply=h,Object.setPrototypeOf(n,e)}else{Object.getOwnPropertyNames(o).forEach(function(e){if(-1===p.indexOf(e)){var t=Object.getOwnPropertyDescriptor(o,e);Object.defineProperty(n,e,t)}})}return u(this,n),c(n)},configurable:!0})}},function(e,t,n){
/*!
 ...
 * MIT Licensed
 */
e.exports=function(e,w){var b=e.Assertion,g=e.AssertionError,m=w.flag;function t(e,t){t&&m(this,"message",t),e=e.toLowerCase();var n=m(this,"object"),o=~["a","e","i","o","u"].indexOf(e.charAt(0))?"an ":"a ";this.assert(e===w.type(n).toLowerCase(),"expected #{this} to be "+o+e,"expected #{this} not to be "+o+e)}function d(e,t){return w.isNaN(e)&&w.isNaN(t)||e===t}function n(){m(this,"contains",!0)}function o(n,e){e&&m(this,"message",e);var o=m(this,"object"),t=w.type(o).toLowerCase(),r=m(this,"message"),i=m(this,"negate"),s=m(this,"ssfi"),a=m(this,"deep"),c=a?"deep ":"";r=r?r+": ":"";var u=!1;switch(t){case"string":u=-1!==o.indexOf(n);break;case"weakset":if(a)throw new g(r+"unable to use .deep.include with WeakSet",void 0,s);u=o.has(n);break;case"map":var f=a?w.eql:d;o.forEach(function(e){u=u||f(e,n)});break;case"set":a?o.forEach(function(e){u=u||w.eql(e,n)}):u=o.has(n);break;case"array":u=a?o.some(function(e){return w.eql(e,n)}):-1!==o.indexOf(n);break;default:if(n!==Object(n))throw new g(r+"object tested must be an array, a map, an object, a set, a string, or a weakset, but "+t+" given",void 0,s);var p=Object.keys(n),l=null,h=0;if(p.forEach(function(e){var t=new b(o);if(w.transferFlags(this,t,!0),m(t,"lockSsfi",!0),i&&1!==p.length)try{t.property(e,n[e])}catch(e){if(!w.checkError.compatibleConstructor(e,g))throw e;null===l&&(l=e),h++}else t.property(e,n[e])},this),i&&1<p.length&&h===p.length)throw l;return}this.assert(u,"expected #{this} to "+c+"include "+w.inspect(n),"expected #{this} to not "+c+"include "+w.inspect(n))}function r(){var e=m(this,"object"),t=w.type(e);this.assert("Arguments"===t,"expected #{this} to be arguments but got "+t,"expected #{this} to not be arguments")}function i(e,t){t&&m(this,"message",t);var n=m(this,"object");if(m(this,"deep")){var o=m(this,"lockSsfi");m(this,"lockSsfi",!0),this.eql(e),m(this,"lockSsfi",o)}else this.assert(e===n,"expected #{this} to equal #{exp}","expected #{this} to not equal #{exp}",e,this._obj,!0)}function s(e,t){t&&m(this,"message",t),this.assert(w.eql(e,m(this,"object")),"expected #{this} to deeply equal #{exp}","expected #{this} to not deeply equal #{exp}",e,this._obj,!0)}function a(e,t){t&&m(this,"message",t);var n,o=m(this,"object"),r=m(this,"doLength"),i=m(this,"message"),s=i?i+": ":"",a=m(this,"ssfi"),c=w.type(o).toLowerCase(),u=w.type(e).toLowerCase(),f=!0;if(r&&"map"!==c&&"set"!==c&&new b(o,i,a,!0).to.have.property("length"),r||"date"!==c||"date"===u)if("number"===u||!r&&"number"!==c)if(r||"date"===c||"number"===c)f=!1;else{n=s+"expected "+("string"===c?"'"+o+"'":o)+" to be a number or a date"}else n=s+"the argument to above must be a number";else n=s+"the argument to above must be a date";if(f)throw new g(n,void 0,a);if(r){var p,l="length";p="map"===c||"set"===c?(l="size",o.size):o.length,this.assert(e<p,"expected #{this} to have a "+l+" above #{exp} but got #{act}","expected #{this} to not have a "+l+" above #{exp}",e,p)}else this.assert(e<o,"expected #{this} to be above #{exp}","expected #{this} to be at most #{exp}",e)}function c(e,t){t&&m(this,"message",t);var n,o=m(this,"object"),r=m(this,"doLength"),i=m(this,"message"),s=i?i+": ":"",a=m(this,"ssfi"),c=w.type(o).toLowerCase(),u=w.type(e).toLowerCase(),f=!0;if(r&&"map"!==c&&"set"!==c&&new b(o,i,a,!0).to.have.property("length"),r||"date"!==c||"date"===u)if("number"===u||!r&&"number"!==c)if(r||"date"===c||"number"===c)f=!1;else{n=s+"expected "+("string"===c?"'"+o+"'":o)+" to be a number or a date"}else n=s+"the argument to least must be a number";else n=s+"the argument to least must be a date";if(f)throw new g(n,void 0,a);if(r){var p,l="length";p="map"===c||"set"===c?(l="size",o.size):o.length,this.assert(e<=p,"expected #{this} to have a "+l+" at least #{exp} but got #{act}","expected #{this} to have a "+l+" below #{exp}",e,p)}else this.assert(e<=o,"expected #{this} to be at least #{exp}","expected #{this} to be below #{exp}",e)}function u(e,t){t&&m(this,"message",t);var n,o=m(this,"object"),r=m(this,"doLength"),i=m(this,"message"),s=i?i+": ":"",a=m(this,"ssfi"),c=w.type(o).toLowerCase(),u=w.type(e).toLowerCase(),f=!0;if(r&&"map"!==c&&"set"!==c&&new b(o,i,a,!0).to.have.property("length"),r||"date"!==c||"date"===u)if("number"===u||!r&&"number"!==c)if(r||"date"===c||"number"===c)f=!1;else{n=s+"expected "+("string"===c?"'"+o+"'":o)+" to be a number or a date"}else n=s+"the argument to below must be a number";else n=s+"the argument to below must be a date";if(f)throw new g(n,void 0,a);if(r){var p,l="length";p="map"===c||"set"===c?(l="size",o.size):o.length,this.assert(p<e,"expected #{this} to have a "+l+" below #{exp} but got #{act}","expected #{this} to not have a "+l+" below #{exp}",e,p)}else this.assert(o<e,"expected #{this} to be below #{exp}","expected #{this} to be at least #{exp}",e)}function f(e,t){t&&m(this,"message",t);var n,o=m(this,"object"),r=m(this,"doLength"),i=m(this,"message"),s=i?i+": ":"",a=m(this,"ssfi"),c=w.type(o).toLowerCase(),u=w.type(e).toLowerCase(),f=!0;if(r&&"map"!==c&&"set"!==c&&new b(o,i,a,!0).to.have.property("length"),r||"date"!==c||"date"===u)if("number"===u||!r&&"number"!==c)if(r||"date"===c||"number"===c)f=!1;else{n=s+"expected "+("string"===c?"'"+o+"'":o)+" to be a number or a date"}else n=s+"the argument to most must be a number";else n=s+"the argument to most must be a date";if(f)throw new g(n,void 0,a);if(r){var p,l="length";p="map"===c||"set"===c?(l="size",o.size):o.length,this.assert(p<=e,"expected #{this} to have a "+l+" at most #{exp} but got #{act}","expected #{this} to have a "+l+" above #{exp}",e,p)}else this.assert(o<=e,"expected #{this} to be at most #{exp}","expected #{this} to be above #{exp}",e)}function p(t,e){e&&m(this,"message",e);var n=m(this,"object"),o=m(this,"ssfi"),r=m(this,"message");try{var i=n instanceof t}catch(e){if(e instanceof TypeError)throw new g((r=r?r+": ":"")+"The instanceof assertion needs a constructor but "+w.type(t)+" was given.",void 0,o);throw e}var s=w.getName(t);null===s&&(s="an unnamed constructor"),this.assert(i,"expected #{this} to be an instance of "+s,"expected #{this} to not be an instance of "+s)}function l(e,t,n){n&&m(this,"message",n);var o=m(this,"nested"),r=m(this,"own"),i=m(this,"message"),s=m(this,"object"),a=m(this,"ssfi"),c=typeof e;if(i=i?i+": ":"",o){if("string"!=c)throw new g(i+"the argument to property must be a string when using nested syntax",void 0,a)}else if("string"!=c&&"number"!=c&&"symbol"!=c)throw new g(i+"the argument to property must be a string, number, or symbol",void 0,a);if(o&&r)throw new g(i+'The "nested" and "own" flags cannot be combined.',void 0,a);if(null==s)throw new g(i+"Target cannot be null or undefined.",void 0,a);var u,f=m(this,"deep"),p=m(this,"negate"),l=o?w.getPathInfo(s,e):null,h=o?l.value:s[e],d="";f&&(d+="deep "),r&&(d+="own "),o&&(d+="nested "),d+="property ",u=r?Object.prototype.hasOwnProperty.call(s,e):o?l.exists:w.hasProperty(s,e),p&&1!==arguments.length||this.assert(u,"expected #{this} to have "+d+w.inspect(e),"expected #{this} to not have "+d+w.inspect(e)),1<arguments.length&&this.assert(u&&(f?w.eql(t,h):t===h),"expected #{this} to have "+d+w.inspect(e)+" of #{exp}, but got #{act}","expected #{this} to not have "+d+w.inspect(e)+" of #{act}",t,h),m(this,"object",h)}function h(e,t,n){m(this,"own",!0),l.apply(this,arguments)}function y(e,t,n){"string"==typeof t&&(n=t,t=null),n&&m(this,"message",n);var o=m(this,"object"),r=Object.getOwnPropertyDescriptor(Object(o),e);r&&t?this.assert(w.eql(t,r),"expected the own property descriptor for "+w.inspect(e)+" on #{this} to match "+w.inspect(t)+", got "+w.inspect(r),"expected the own property descriptor for "+w.inspect(e)+" on #{this} to not match "+w.inspect(t),t,r,!0):this.assert(r,"expected #{this} to have an own property descriptor for "+w.inspect(e),"expected #{this} to not have an own property descriptor for "+w.inspect(e)),m(this,"object",r)}function v(){m(this,"doLength",!0)}function x(e,t){t&&m(this,"message",t);var n,o=m(this,"object"),r=w.type(o).toLowerCase(),i=m(this,"message"),s=m(this,"ssfi"),a="length";switch(r){case"map":case"set":a="size",n=o.size;break;default:new b(o,i,s,!0).to.have.property("length"),n=o.length}this.assert(n==e,"expected #{this} to have a "+a+" of #{exp} but got #{act}","expected #{this} to not have a "+a+" of #{act}",e,n)}function O(e,t){t&&m(this,"message",t);var n=m(this,"object");this.assert(e.exec(n),"expected #{this} to match "+e,"expected #{this} not to match "+e)}function j(e){var t,n,o=m(this,"object"),r=w.type(o),i=w.type(e),s=m(this,"ssfi"),a=m(this,"deep"),c="",u=!0,f=m(this,"message"),p=(f=f?f+": ":"")+"when testing keys against an object or an array you must give a single Array|Object|String argument or multiple String arguments";if("Map"===r||"Set"===r)c=a?"deeply ":"",n=[],o.forEach(function(e,t){n.push(t)}),"Array"!==i&&(e=Array.prototype.slice.call(arguments));else{switch(n=w.getOwnEnumerableProperties(o),i){case"Array":if(1<arguments.length)throw new g(p,void 0,s);break;case"Object":if(1<arguments.length)throw new g(p,void 0,s);e=Object.keys(e);break;default:e=Array.prototype.slice.call(arguments)}e=e.map(function(e){return"symbol"==typeof e?e:String(e)})}if(!e.length)throw new g(f+"keys required",void 0,s);var l=e.length,h=m(this,"any"),d=m(this,"all"),y=e;if(h||d||(d=!0),h&&(u=y.some(function(t){return n.some(function(e){return a?w.eql(t,e):t===e})})),d&&(u=y.every(function(t){return n.some(function(e){return a?w.eql(t,e):t===e})}),m(this,"contains")||(u=u&&e.length==n.length)),1<l){var b=(e=e.map(function(e){return w.inspect(e)})).pop();d&&(t=e.join(", ")+", and "+b),h&&(t=e.join(", ")+", or "+b)}else t=w.inspect(e[0]);t=(1<l?"keys ":"key ")+t,t=(m(this,"contains")?"contain ":"have ")+t,this.assert(u,"expected #{this} to "+c+t,"expected #{this} to not "+c+t,y.slice(0).sort(w.compareByInspect),n.sort(w.compareByInspect),!0)}function M(e,t,n){n&&m(this,"message",n);var o,r=m(this,"object"),i=m(this,"ssfi"),s=m(this,"message"),a=m(this,"negate")||!1;new b(r,s,i,!0).is.a("function"),(e instanceof RegExp||"string"==typeof e)&&(t=e,e=null);try{r()}catch(e){o=e}var c=void 0===e&&void 0===t,u=Boolean(e&&t),f=!1,p=!1;if(c||!c&&!a){var l="an error";e instanceof Error?l="#{exp}":e&&(l=w.checkError.getConstructorName(e)),this.assert(o,"expected #{this} to throw "+l,"expected #{this} to not throw an error but #{act} was thrown",e&&e.toString(),o instanceof Error?o.toString():"string"==typeof o?o:o&&w.checkError.getConstructorName(o))}if(e&&o){if(e instanceof Error)w.checkError.compatibleInstance(o,e)===a&&(u&&a?f=!0:this.assert(a,"expected #{this} to throw #{exp} but #{act} was thrown","expected #{this} to not throw #{exp}"+(o&&!a?" but #{act} was thrown":""),e.toString(),o.toString()));w.checkError.compatibleConstructor(o,e)===a&&(u&&a?f=!0:this.assert(a,"expected #{this} to throw #{exp} but #{act} was thrown","expected #{this} to not throw #{exp}"+(o?" but #{act} was thrown":""),e instanceof Error?e.toString():e&&w.checkError.getConstructorName(e),o instanceof Error?o.toString():o&&w.checkError.getConstructorName(o)))}if(o&&null!=t){var h="including";t instanceof RegExp&&(h="matching"),w.checkError.compatibleMessage(o,t)===a&&(u&&a?p=!0:this.assert(a,"expected #{this} to throw error "+h+" #{exp} but got #{act}","expected #{this} to throw error not "+h+" #{exp}",t,w.checkError.getMessage(o)))}f&&p&&this.assert(a,"expected #{this} to throw #{exp} but #{act} was thrown","expected #{this} to not throw #{exp}"+(o?" but #{act} was thrown":""),e instanceof Error?e.toString():e&&w.checkError.getConstructorName(e),o instanceof Error?o.toString():o&&w.checkError.getConstructorName(o)),m(this,"object",o)}function S(e,t){t&&m(this,"message",t);var n=m(this,"object"),o=m(this,"itself"),r="function"!=typeof n||o?n[e]:n.prototype[e];this.assert("function"==typeof r,"expected #{this} to respond to "+w.inspect(e),"expected #{this} to not respond to "+w.inspect(e))}function N(e,t){t&&m(this,"message",t);var n=e(m(this,"object"));this.assert(n,"expected #{this} to satisfy "+w.objDisplay(e),"expected #{this} to not satisfy"+w.objDisplay(e),!m(this,"negate"),n)}function P(e,t,n){n&&m(this,"message",n);var o=m(this,"object"),r=m(this,"message"),i=m(this,"ssfi");if(new b(o,r,i,!0).is.a("number"),"number"!=typeof e||"number"!=typeof t)throw new g((r=r?r+": ":"")+"the arguments to closeTo or approximately must be numbers",void 0,i);this.assert(Math.abs(o-e)<=t,"expected #{this} to be close to "+e+" +/- "+t,"expected #{this} not to be close to "+e+" +/- "+t)}function E(e,t,n){n&&m(this,"message",n);var o,r=m(this,"object"),i=m(this,"message"),s=m(this,"ssfi");new b(r,i,s,!0).is.a("function"),o=t?(new b(e,i,s,!0).to.have.property(t),e[t]):(new b(e,i,s,!0).is.a("function"),e()),r();var a=null==t?e():e[t],c=null==t?o:"."+t;m(this,"deltaMsgObj",c),m(this,"initialDeltaValue",o),m(this,"finalDeltaValue",a),m(this,"deltaBehavior","change"),m(this,"realDelta",a!==o),this.assert(o!==a,"expected "+c+" to change","expected "+c+" to not change")}function k(e,t,n){n&&m(this,"message",n);var o,r=m(this,"object"),i=m(this,"message"),s=m(this,"ssfi");new b(r,i,s,!0).is.a("function"),o=t?(new b(e,i,s,!0).to.have.property(t),e[t]):(new b(e,i,s,!0).is.a("function"),e()),new b(o,i,s,!0).is.a("number"),r();var a=null==t?e():e[t],c=null==t?o:"."+t;m(this,"deltaMsgObj",c),m(this,"initialDeltaValue",o),m(this,"finalDeltaValue",a),m(this,"deltaBehavior","increase"),m(this,"realDelta",a-o),this.assert(0<a-o,"expected "+c+" to increase","expected "+c+" to not increase")}function A(e,t,n){n&&m(this,"message",n);var o,r=m(this,"object"),i=m(this,"message"),s=m(this,"ssfi");new b(r,i,s,!0).is.a("function"),o=t?(new b(e,i,s,!0).to.have.property(t),e[t]):(new b(e,i,s,!0).is.a("function"),e()),new b(o,i,s,!0).is.a("number"),r();var a=null==t?e():e[t],c=null==t?o:"."+t;m(this,"deltaMsgObj",c),m(this,"initialDeltaValue",o),m(this,"finalDeltaValue",a),m(this,"deltaBehavior","decrease"),m(this,"realDelta",o-a),this.assert(a-o<0,"expected "+c+" to decrease","expected "+c+" to not decrease")}["to","be","been","is","and","has","have","with","that","which","at","of","same","but","does","still"].forEach(function(e){b.addProperty(e)}),b.addProperty("not",function(){m(this,"negate",!0)}),b.addProperty("deep",function(){m(this,"deep",!0)}),b.addProperty("nested",function(){m(this,"nested",!0)}),b.addProperty("own",function(){m(this,"own",!0)}),b.addProperty("ordered",function(){m(this,"ordered",!0)}),b.addProperty("any",function(){m(this,"any",!0),m(this,"all",!1)}),b.addProperty("all",function(){m(this,"all",!0),m(this,"any",!1)}),b.addChainableMethod("an",t),b.addChainableMethod("a",t),b.addChainableMethod("include",o,n),b.addChainableMethod("contain",o,n),b.addChainableMethod("contains",o,n),b.addChainableMethod("includes",o,n),b.addProperty("ok",function(){this.assert(m(this,"object"),"expected #{this} to be truthy","expected #{this} to be falsy")}),b.addProperty("true",function(){this.assert(!0===m(this,"object"),"expected #{this} to be true","expected #{this} to be false",!m(this,"negate"))}),b.addProperty("false",function(){this.assert(!1===m(this,"object"),"expected #{this} to be false","expected #{this} to be true",!!m(this,"negate"))}),b.addProperty("null",function(){this.assert(null===m(this,"object"),"expected #{this} to be null","expected #{this} not to be null")}),b.addProperty("undefined",function(){this.assert(void 0===m(this,"object"),"expected #{this} to be undefined","expected #{this} not to be undefined")}),b.addProperty("NaN",function(){this.assert(w.isNaN(m(this,"object")),"expected #{this} to be NaN","expected #{this} not to be NaN")}),b.addProperty("exist",function(){var e=m(this,"object");this.assert(null!=e,"expected #{this} to exist","expected #{this} to not exist")}),b.addProperty("empty",function(){var e,t=m(this,"object"),n=m(this,"ssfi"),o=m(this,"message");switch(o=o?o+": ":"",w.type(t).toLowerCase()){case"array":case"string":e=t.length;break;case"map":case"set":e=t.size;break;case"weakmap":case"weakset":throw new g(o+".empty was passed a weak collection",void 0,n);case"function":var r=o+".empty was passed a function "+w.getName(t);throw new g(r.trim(),void 0,n);default:if(t!==Object(t))throw new g(o+".empty was passed non-string primitive "+w.inspect(t),void 0,n);e=Object.keys(t).length}this.assert(0===e,"expected #{this} to be empty","expected #{this} not to be empty")}),b.addProperty("arguments",r),b.addProperty("Arguments",r),b.addMethod("equal",i),b.addMethod("equals",i),b.addMethod("eq",i),b.addMethod("eql",s),b.addMethod("eqls",s),b.addMethod("above",a),b.addMethod("gt",a),b.addMethod("greaterThan",a),b.addMethod("least",c),b.addMethod("gte",c),b.addMethod("below",u),b.addMethod("lt",u),b.addMethod("lessThan",u),b.addMethod("most",f),b.addMethod("lte",f),b.addMethod("within",function(e,t,n){n&&m(this,"message",n);var o,r=m(this,"object"),i=m(this,"doLength"),s=m(this,"message"),a=s?s+": ":"",c=m(this,"ssfi"),u=w.type(r).toLowerCase(),f=w.type(e).toLowerCase(),p=w.type(t).toLowerCase(),l=!0,h="date"===f&&"date"===p?e.toUTCString()+".."+t.toUTCString():e+".."+t;if(i&&"map"!==u&&"set"!==u&&new b(r,s,c,!0).to.have.property("length"),i||"date"!==u||"date"===f&&"date"===p)if("number"===f&&"number"===p||!i&&"number"!==u)if(i||"date"===u||"number"===u)l=!1;else{o=a+"expected "+("string"===u?"'"+r+"'":r)+" to be a number or a date"}else o=a+"the arguments to within must be numbers";else o=a+"the arguments to within must be dates";if(l)throw new g(o,void 0,c);if(i){var d,y="length";d="map"===u||"set"===u?(y="size",r.size):r.length,this.assert(e<=d&&d<=t,"expected #{this} to have a "+y+" within "+h,"expected #{this} to not have a "+y+" within "+h)}else this.assert(e<=r&&r<=t,"expected #{this} to be within "+h,"expected #{this} to not be within "+h)}),b.addMethod("instanceof",p),b.addMethod("instanceOf",p),b.addMethod("property",l),b.addMethod("ownProperty",h),b.addMethod("haveOwnProperty",h),b.addMethod("ownPropertyDescriptor",y),b.addMethod("haveOwnPropertyDescriptor",y),b.addChainableMethod("length",x,v),b.addChainableMethod("lengthOf",x,v),b.addMethod("match",O),b.addMethod("matches",O),b.addMethod("string",function(e,t){t&&m(this,"message",t);var n=m(this,"object"),o=m(this,"message"),r=m(this,"ssfi");new b(n,o,r,!0).is.a("string"),this.assert(~n.indexOf(e),"expected #{this} to contain "+w.inspect(e),"expected #{this} to not contain "+w.inspect(e))}),b.addMethod("keys",j),b.addMethod("key",j),b.addMethod("throw",M),b.addMethod("throws",M),b.addMethod("Throw",M),b.addMethod("respondTo",S),b.addMethod("respondsTo",S),b.addProperty("itself",function(){m(this,"itself",!0)}),b.addMethod("satisfy",N),b.addMethod("satisfies",N),b.addMethod("closeTo",P),b.addMethod("approximately",P),b.addMethod("members",function(e,t){t&&m(this,"message",t);var n=m(this,"object"),o=m(this,"message"),r=m(this,"ssfi");new b(n,o,r,!0).to.be.an("array"),new b(e,o,r,!0).to.be.an("array");var i,s,a,c=m(this,"contains"),u=m(this,"ordered");a=c?(s="expected #{this} to be "+(i=u?"an ordered superset":"a superset")+" of #{exp}","expected #{this} to not be "+i+" of #{exp}"):(s="expected #{this} to have the same "+(i=u?"ordered members":"members")+" as #{exp}","expected #{this} to not have the same "+i+" as #{exp}");var f=m(this,"deep")?w.eql:void 0;this.assert(function(e,o,r,i,s){if(!i){if(e.length!==o.length)return!1;o=o.slice()}return e.every(function(n,e){if(s)return r?r(n,o[e]):n===o[e];if(r)return o.some(function(e,t){return!!r(n,e)&&(i||o.splice(t,1),!0)});var t=o.indexOf(n);return-1!==t&&(i||o.splice(t,1),!0)})}(e,n,f,c,u),s,a,e,n,!0)}),b.addMethod("oneOf",function(e,t){t&&m(this,"message",t);var n=m(this,"object"),o=m(this,"message"),r=m(this,"ssfi");new b(e,o,r,!0).to.be.an("array"),this.assert(-1<e.indexOf(n),"expected #{this} to be one of #{exp}","expected #{this} to not be one of #{exp}",e,n)}),b.addMethod("change",E),b.addMethod("changes",E),b.addMethod("increase",k),b.addMethod("increases",k),b.addMethod("decrease",A),b.addMethod("decreases",A),b.addMethod("by",function(e,t){t&&m(this,"message",t);var n,o=m(this,"deltaMsgObj"),r=m(this,"initialDeltaValue"),i=m(this,"finalDeltaValue"),s=m(this,"deltaBehavior"),a=m(this,"realDelta");n="change"===s?Math.abs(i-r)===Math.abs(e):a===Math.abs(e),this.assert(n,"expected "+o+" to "+s+" by "+e,"expected "+o+" to not "+s+" by "+e)}),b.addProperty("extensible",function(){var e=m(this,"object"),t=e===Object(e)&&Object.isExtensible(e);this.assert(t,"expected #{this} to be extensible","expected #{this} to not be extensible")}),b.addProperty("sealed",function(){var e=m(this,"object"),t=e!==Object(e)||Object.isSealed(e);this.assert(t,"expected #{this} to be sealed","expected #{this} to not be sealed")}),b.addProperty("frozen",function(){var e=m(this,"object"),t=e!==Object(e)||Object.isFrozen(e);this.assert(t,"expected #{this} to be frozen","expected #{this} to not be frozen")}),b.addProperty("finite",function(e){var t=m(this,"object");this.assert("number"==typeof t&&isFinite(t),"expected #{this} to be a finite number","expected #{this} to not be a finite number")})}},function(e,t){
/*!
 * chai
 * Copyright(c) 2011-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
...
/*!
   * Aliases.
   */
function e(t,n){return f[n]=f[t],e}("isOk","ok")("isNotOk","notOk")("throws","throw")("throws","Throw")("isExtensible","extensible")("isNotExtensible","notExtensible")("isSealed","sealed")("isNotSealed","notSealed")("isFrozen","frozen")("isNotFrozen","notFrozen")("isEmpty","empty")("isNotEmpty","notEmpty")}},,,,function(e,t,n){"use strict";e.exports=function(e,t,n,o){Object.defineProperty(e,"name",{enumerable:!0,value:n}),Object.defineProperty(e,"version",{enumerable:!0,value:o}),Object.defineProperty(e,n,{enumerable:!0,value:!0});for(var r=0,i=t.length;r<i;r++)t[r]!==n&&Object.defineProperty(e,t[r],{enumerable:!0,value:!1})}},,,,,,,,,,,,,,,,,function(e,t,n){e.exports=n(60)},function(e,t,n){"use strict";var o=n(42),r=n(15).expect;describe("set-name-and-version",function(){it("Should execute normal behaviors",function(){var e={};o(e,["AAA","BBB","CCC"],"BBB","12.3.4"),r(e).to.deep.equal({name:"BBB",version:"12.3.4",AAA:!1,BBB:!0,CCC:!1})}),it("Cannot rewrite properties",function(){var e={};o(e,["AAA","BBB","CCC"],"BBB","12.3.4"),r(function(){e.name="AAA"}).to.throws(Error),r(function(){e.version="9.9.9"}).to.throws(Error),r(function(){e.AAA=!0}).to.throws(Error),r(function(){e.BBB=!1}).to.throws(Error),r(function(){e.CCC=!0}).to.throws(Error),r(e.name).to.equal("BBB"),r(e.version).to.equal("12.3.4"),r(e.AAA).to.be.false,r(e.BBB).to.be.true,r(e.CCC).to.be.false})})}]);