...
*/function d(e,t,n,o){if(n&&!i(e)&&!i(t)){var r=n.get(e);r?r.set(t,o):((r=new l).set(t,o),n.set(e,r))}}
/*!
 * Primary Export
 */function p(e,t,n){if(n&&n.comparator)return r(e,t,n);var o=b(e,t);return null!==o?o:r(e,t,n)}function b(e,t){return e===t?0!==e||1/e==1/t:e!=e&&t!=t||!i(e)&&!i(t)&&null}
/*!
...
*/function r(e,t,n){(n=n||{}).memoize=!1!==n.memoize&&(n.memoize||new l);var o=n&&n.comparator,r=h(e,t,n.memoize);if(null!==r)return r;var i=h(t,e,n.memoize);if(null!==i)return i;if(o){var s=o(e,t);if(!1===s||!0===s)return d(e,t,n.memoize,s),s;var a=b(e,t);if(null!==a)return a}var c=f(e);if(c!==f(t))return d(e,t,n.memoize,!1),!1;d(e,t,n.memoize,!0);var u=function(e,t,n,o){switch(n){case"String":case"Number":case"Boolean":case"Date":return p(e.valueOf(),t.valueOf());case"Promise":case"Symbol":case"function":case"WeakMap":case"WeakSet":case"Error":return e===t;case"Arguments":case"Int8Array":case"Uint8Array":case"Uint8ClampedArray":case"Int16Array":case"Uint16Array":case"Int32Array":case"Uint32Array":case"Float32Array":case"Float64Array":case"Array":return m(e,t,o);case"RegExp":
/*!
 ...
 */(e,t,o);case"DataView":return m(new Uint8Array(e.buffer),new Uint8Array(t.buffer),o);case"ArrayBuffer":return m(new Uint8Array(e),new Uint8Array(t),o);case"Set":case"Map":return y(e,t,o);default:
/*!
 ...
 * @return {Boolean} result
 */
function(e,t,n,o){var r=n.length;if(0===r)return!0;for(var i=0;i<r;i+=1)if(!1===p(e[n[i]],t[n[i]],o))return!1;return!0}(e,t,o,n);var i=g(e),s=g(t);if(i.length&&i.length===s.length)return i.sort(),s.sort(),m(i,s,n);return 0===o.length&&0===i.length&&0===r.length&&0===s.length}
/*!
 ...
 * @param {Mixed} value
 * @return {Boolean} result
 */(e,t,o)}}(e,t,c,n);return d(e,t,n.memoize,u),u}function y(e,t,n){if(e.size!==t.size)return!1;if(0===e.size)return!0;var o=[],r=[];return e.forEach(function(e,t){o.push([e,t])}),t.forEach(function(e,t){r.push([e,t])}),m(o.sort(),r.sort(),n)}
/*!
 ...
 * @param {Object} [options] (Optional)
 * @return {Boolean} result
 */function m(e,t,n){var o=e.length;if(o!==t.length)return!1;if(0===o)return!0;for(var r=-1;++r<o;)if(!1===p(e[r],t[r],n))return!1;return!0}
/*!
 ...
 */function v(e){var t=[];for(var n in e)t.push(n);return t}function i(e){return null===e||"object"!=typeof e}e.exports=p,e.exports.MemoizeMap=l},function(e,t,n){
/*!
 ...
 * MIT Licensed
 */
e.exports=function(e,m){var y=e.Assertion,g=e.AssertionError,w=m.flag;function t(e,t){t&&w(this,"message",t),e=e.toLowerCase();var n=w(this,"object"),o=~["a","e","i","o","u"].indexOf(e.charAt(0))?"an ":"a ";this.assert(e===m.type(n).toLowerCase(),"expected #{this} to be "+o+e,"expected #{this} not to be "+o+e)}function p(e,t){return m.isNaN(e)&&m.isNaN(t)||e===t}function n(){w(this,"contains",!0)}function o(n,e){e&&w(this,"message",e);var o=w(this,"object"),t=m.type(o).toLowerCase(),r=w(this,"message"),i=w(this,"negate"),s=w(this,"ssfi"),a=w(this,"deep"),c=a?"deep ":"";r=r?r+": ":"";var u=!1;switch(t){case"string":u=-1!==o.indexOf(n);break;case"weakset":if(a)throw new g(r+"unable to use .deep.include with WeakSet",void 0,s);u=o.has(n);break;case"map":var f=a?m.eql:p;o.forEach(function(e){u=u||f(e,n)});break;case"set":a?o.forEach(function(e){u=u||m.eql(e,n)}):u=o.has(n);break;case"array":u=a?o.some(function(e){return m.eql(e,n)}):-1!==o.indexOf(n);break;default:if(n!==Object(n))throw new g(r+"object tested must be an array, a map, an object, a set, a string, or a weakset, but "+t+" given",void 0,s);var l=Object.keys(n),h=null,d=0;if(l.forEach(function(e){var t=new y(o);if(m.transferFlags(this,t,!0),w(t,"lockSsfi",!0),i&&1!==l.length)try{t.property(e,n[e])}catch(e){if(!m.checkError.compatibleConstructor(e,g))throw e;null===h&&(h=e),d++}else t.property(e,n[e])},this),i&&1<l.length&&d===l.length)throw h;return}this.assert(u,"expected #{this} to "+c+"include "+m.inspect(n),"expected #{this} to not "+c+"include "+m.inspect(n))}function r(){var e=w(this,"object"),t=m.type(e);this.assert("Arguments"===t,"expected #{this} to be arguments but got "+t,"expected #{this} to not be arguments")}function i(e,t){t&&w(this,"message",t);var n=w(this,"object");if(w(this,"deep")){var o=w(this,"lockSsfi");w(this,"lockSsfi",!0),this.eql(e),w(this,"lockSsfi",o)}else this.assert(e===n,"expected #{this} to equal #{exp}","expected #{this} to not equal #{exp}",e,this._obj,!0)}function s(e,t){t&&w(this,"message",t),this.assert(m.eql(e,w(this,"object")),"expected #{this} to deeply equal #{exp}","expected #{this} to not deeply equal #{exp}",e,this._obj,!0)}function a(e,t){t&&w(this,"message",t);var n,o=w(this,"object"),r=w(this,"doLength"),i=w(this,"message"),s=i?i+": ":"",a=w(this,"ssfi"),c=m.type(o).toLowerCase(),u=m.type(e).toLowerCase(),f=!0;if(r&&"map"!==c&&"set"!==c&&new y(o,i,a,!0).to.have.property("length"),r||"date"!==c||"date"===u)if("number"===u||!r&&"number"!==c)if(r||"date"===c||"number"===c)f=!1;else{n=s+"expected "+("string"===c?"'"+o+"'":o)+" to be a number or a date"}else n=s+"the argument to above must be a number";else n=s+"the argument to above must be a date";if(f)throw new g(n,void 0,a);if(r){var l,h="length";l="map"===c||"set"===c?(h="size",o.size):o.length,this.assert(e<l,"expected #{this} to have a "+h+" above #{exp} but got #{act}","expected #{this} to not have a "+h+" above #{exp}",e,l)}else this.assert(e<o,"expected #{this} to be above #{exp}","expected #{this} to be at most #{exp}",e)}function c(e,t){t&&w(this,"message",t);var n,o=w(this,"object"),r=w(this,"doLength"),i=w(this,"message"),s=i?i+": ":"",a=w(this,"ssfi"),c=m.type(o).toLowerCase(),u=m.type(e).toLowerCase(),f=!0;if(r&&"map"!==c&&"set"!==c&&new y(o,i,a,!0).to.have.property("length"),r||"date"!==c||"date"===u)if("number"===u||!r&&"number"!==c)if(r||"date"===c||"number"===c)f=!1;else{n=s+"expected "+("string"===c?"'"+o+"'":o)+" to be a number or a date"}else n=s+"the argument to least must be a number";else n=s+"the argument to least must be a date";if(f)throw new g(n,void 0,a);if(r){var l,h="length";l="map"===c||"set"===c?(h="size",o.size):o.length,this.assert(e<=l,"expected #{this} to have a "+h+" at least #{exp} but got #{act}","expected #{this} to have a "+h+" below #{exp}",e,l)}else this.assert(e<=o,"expected #{this} to be at least #{exp}","expected #{this} to be below #{exp}",e)}function u(e,t){t&&w(this,"message",t);var n,o=w(this,"object"),r=w(this,"doLength"),i=w(this,"message"),s=i?i+": ":"",a=w(this,"ssfi"),c=m.type(o).toLowerCase(),u=m.type(e).toLowerCase(),f=!0;if(r&&"map"!==c&&"set"!==c&&new y(o,i,a,!0).to.have.property("length"),r||"date"!==c||"date"===u)if("number"===u||!r&&"number"!==c)if(r||"date"===c||"number"===c)f=!1;else{n=s+"expected "+("string"===c?"'"+o+"'":o)+" to be a number or a date"}else n=s+"the argument to below must be a number";else n=s+"the argument to below must be a date";if(f)throw new g(n,void 0,a);if(r){var l,h="length";l="map"===c||"set"===c?(h="size",o.size):o.length,this.assert(l<e,"expected #{this} to have a "+h+" below #{exp} but got #{act}","expected #{this} to not have a "+h+" below #{exp}",e,l)}else this.assert(o<e,"expected #{this} to be below #{exp}","expected #{this} to be at least #{exp}",e)}function f(e,t){t&&w(this,"message",t);var n,o=w(this,"object"),r=w(this,"doLength"),i=w(this,"message"),s=i?i+": ":"",a=w(this,"ssfi"),c=m.type(o).toLowerCase(),u=m.type(e).toLowerCase(),f=!0;if(r&&"map"!==c&&"set"!==c&&new y(o,i,a,!0).to.have.property("length"),r||"date"!==c||"date"===u)if("number"===u||!r&&"number"!==c)if(r||"date"===c||"number"===c)f=!1;else{n=s+"expected "+("string"===c?"'"+o+"'":o)+" to be a number or a date"}else n=s+"the argument to most must be a number";else n=s+"the argument to most must be a date";if(f)throw new g(n,void 0,a);if(r){var l,h="length";l="map"===c||"set"===c?(h="size",o.size):o.length,this.assert(l<=e,"expected #{this} to have a "+h+" at most #{exp} but got #{act}","expected #{this} to have a "+h+" above #{exp}",e,l)}else this.assert(o<=e,"expected #{this} to be at most #{exp}","expected #{this} to be above #{exp}",e)}function l(t,e){e&&w(this,"message",e);var n=w(this,"object"),o=w(this,"ssfi"),r=w(this,"message");try{var i=n instanceof t}catch(e){if(e instanceof TypeError)throw new g((r=r?r+": ":"")+"The instanceof assertion needs a constructor but "+m.type(t)+" was given.",void 0,o);throw e}var s=m.getName(t);null===s&&(s="an unnamed constructor"),this.assert(i,"expected #{this} to be an instance of "+s,"expected #{this} to not be an instance of "+s)}function h(e,t,n){n&&w(this,"message",n);var o=w(this,"nested"),r=w(this,"own"),i=w(this,"message"),s=w(this,"object"),a=w(this,"ssfi"),c=typeof e;if(i=i?i+": ":"",o){if("string"!=c)throw new g(i+"the argument to property must be a string when using nested syntax",void 0,a)}else if("string"!=c&&"number"!=c&&"symbol"!=c)throw new g(i+"the argument to property must be a string, number, or symbol",void 0,a);if(o&&r)throw new g(i+'The "nested" and "own" flags cannot be combined.',void 0,a);if(null==s)throw new g(i+"Target cannot be null or undefined.",void 0,a);var u,f=w(this,"deep"),l=w(this,"negate"),h=o?m.getPathInfo(s,e):null,d=o?h.value:s[e],p="";f&&(p+="deep "),r&&(p+="own "),o&&(p+="nested "),p+="property ",u=r?Object.prototype.hasOwnProperty.call(s,e):o?h.exists:m.hasProperty(s,e),l&&1!==arguments.length||this.assert(u,"expected #{this} to have "+p+m.inspect(e),"expected #{this} to not have "+p+m.inspect(e)),1<arguments.length&&this.assert(u&&(f?m.eql(t,d):t===d),"expected #{this} to have "+p+m.inspect(e)+" of #{exp}, but got #{act}","expected #{this} to not have "+p+m.inspect(e)+" of #{act}",t,d),w(this,"object",d)}function d(e,t,n){w(this,"own",!0),h.apply(this,arguments)}function b(e,t,n){"string"==typeof t&&(n=t,t=null),n&&w(this,"message",n);var o=w(this,"object"),r=Object.getOwnPropertyDescriptor(Object(o),e);r&&t?this.assert(m.eql(t,r),"expected the own property descriptor for "+m.inspect(e)+" on #{this} to match "+m.inspect(t)+", got "+m.inspect(r),"expected the own property descriptor for "+m.inspect(e)+" on #{this} to not match "+m.inspect(t),t,r,!0):this.assert(r,"expected #{this} to have an own property descriptor for "+m.inspect(e),"expected #{this} to not have an own property descriptor for "+m.inspect(e)),w(this,"object",r)}function v(){w(this,"doLength",!0)}function x(e,t){t&&w(this,"message",t);var n,o=w(this,"object"),r=m.type(o).toLowerCase(),i=w(this,"message"),s=w(this,"ssfi"),a="length";switch(r){case"map":case"set":a="size",n=o.size;break;default:new y(o,i,s,!0).to.have.property("length"),n=o.length}this.assert(n==e,"expected #{this} to have a "+a+" of #{exp} but got #{act}","expected #{this} to not have a "+a+" of #{act}",e,n)}function O(e,t){t&&w(this,"message",t);var n=w(this,"object");this.assert(e.exec(n),"expected #{this} to match "+e,"expected #{this} not to match "+e)}function N(e){var t,n,o=w(this,"object"),r=m.type(o),i=m.type(e),s=w(this,"ssfi"),a=w(this,"deep"),c="",u=!0,f=w(this,"message"),l=(f=f?f+": ":"")+"when testing keys against an object or an array you must give a single Array|Object|String argument or multiple String arguments";if("Map"===r||"Set"===r)c=a?"deeply ":"",n=[],o.forEach(function(e,t){n.push(t)}),"Array"!==i&&(e=Array.prototype.slice.call(arguments));else{switch(n=m.getOwnEnumerableProperties(o),i){case"Array":if(1<arguments.length)throw new g(l,void 0,s);break;case"Object":if(1<arguments.length)throw new g(l,void 0,s);e=Object.keys(e);break;default:e=Array.prototype.slice.call(arguments)}e=e.map(function(e){return"symbol"==typeof e?e:String(e)})}if(!e.length)throw new g(f+"keys required",void 0,s);var h=e.length,d=w(this,"any"),p=w(this,"all"),b=e;if(d||p||(p=!0),d&&(u=b.some(function(t){return n.some(function(e){return a?m.eql(t,e):t===e})})),p&&(u=b.every(function(t){return n.some(function(e){return a?m.eql(t,e):t===e})}),w(this,"contains")||(u=u&&e.length==n.length)),1<h){var y=(e=e.map(function(e){return m.inspect(e)})).pop();p&&(t=e.join(", ")+", and "+y),d&&(t=e.join(", ")+", or "+y)}else t=m.inspect(e[0]);t=(1<h?"keys ":"key ")+t,t=(w(this,"contains")?"contain ":"have ")+t,this.assert(u,"expected #{this} to "+c+t,"expected #{this} to not "+c+t,b.slice(0).sort(m.compareByInspect),n.sort(m.compareByInspect),!0)}function S(e,t,n){n&&w(this,"message",n);var o,r=w(this,"object"),i=w(this,"ssfi"),s=w(this,"message"),a=w(this,"negate")||!1;new y(r,s,i,!0).is.a("function"),(e instanceof RegExp||"string"==typeof e)&&(t=e,e=null);try{r()}catch(e){o=e}var c=void 0===e&&void 0===t,u=Boolean(e&&t),f=!1,l=!1;if(c||!c&&!a){var h="an error";e instanceof Error?h="#{exp}":e&&(h=m.checkError.getConstructorName(e)),this.assert(o,"expected #{this} to throw "+h,"expected #{this} to not throw an error but #{act} was thrown",e&&e.toString(),o instanceof Error?o.toString():"string"==typeof o?o:o&&m.checkError.getConstructorName(o))}if(e&&o){if(e instanceof Error)m.checkError.compatibleInstance(o,e)===a&&(u&&a?f=!0:this.assert(a,"expected #{this} to throw #{exp} but #{act} was thrown","expected #{this} to not throw #{exp}"+(o&&!a?" but #{act} was thrown":""),e.toString(),o.toString()));m.checkError.compatibleConstructor(o,e)===a&&(u&&a?f=!0:this.assert(a,"expected #{this} to throw #{exp} but #{act} was thrown","expected #{this} to not throw #{exp}"+(o?" but #{act} was thrown":""),e instanceof Error?e.toString():e&&m.checkError.getConstructorName(e),o instanceof Error?o.toString():o&&m.checkError.getConstructorName(o)))}if(o&&null!=t){var d="including";t instanceof RegExp&&(d="matching"),m.checkError.compatibleMessage(o,t)===a&&(u&&a?l=!0:this.assert(a,"expected #{this} to throw error "+d+" #{exp} but got #{act}","expected #{this} to throw error not "+d+" #{exp}",t,m.checkError.getMessage(o)))}f&&l&&this.assert(a,"expected #{this} to throw #{exp} but #{act} was thrown","expected #{this} to not throw #{exp}"+(o?" but #{act} was thrown":""),e instanceof Error?e.toString():e&&m.checkError.getConstructorName(e),o instanceof Error?o.toString():o&&m.checkError.getConstructorName(o)),w(this,"object",o)}function M(e,t){t&&w(this,"message",t);var n=w(this,"object"),o=w(this,"itself"),r="function"!=typeof n||o?n[e]:n.prototype[e];this.assert("function"==typeof r,"expected #{this} to respond to "+m.inspect(e),"expected #{this} to not respond to "+m.inspect(e))}function j(e,t){t&&w(this,"message",t);var n=e(w(this,"object"));this.assert(n,"expected #{this} to satisfy "+m.objDisplay(e),"expected #{this} to not satisfy"+m.objDisplay(e),!w(this,"negate"),n)}function A(e,t,n){n&&w(this,"message",n);var o=w(this,"object"),r=w(this,"message"),i=w(this,"ssfi");if(new y(o,r,i,!0).is.a("number"),"number"!=typeof e||"number"!=typeof t)throw new g((r=r?r+": ":"")+"the arguments to closeTo or approximately must be numbers",void 0,i);this.assert(Math.abs(o-e)<=t,"expected #{this} to be close to "+e+" +/- "+t,"expected #{this} not to be close to "+e+" +/- "+t)}function P(e,t,n){n&&w(this,"message",n);var o,r=w(this,"object"),i=w(this,"message"),s=w(this,"ssfi");new y(r,i,s,!0).is.a("function"),o=t?(new y(e,i,s,!0).to.have.property(t),e[t]):(new y(e,i,s,!0).is.a("function"),e()),r();var a=null==t?e():e[t],c=null==t?o:"."+t;w(this,"deltaMsgObj",c),w(this,"initialDeltaValue",o),w(this,"finalDeltaValue",a),w(this,"deltaBehavior","change"),w(this,"realDelta",a!==o),this.assert(o!==a,"expected "+c+" to change","expected "+c+" to not change")}function E(e,t,n){n&&w(this,"message",n);var o,r=w(this,"object"),i=w(this,"message"),s=w(this,"ssfi");new y(r,i,s,!0).is.a("function"),o=t?(new y(e,i,s,!0).to.have.property(t),e[t]):(new y(e,i,s,!0).is.a("function"),e()),new y(o,i,s,!0).is.a("number"),r();var a=null==t?e():e[t],c=null==t?o:"."+t;w(this,"deltaMsgObj",c),w(this,"initialDeltaValue",o),w(this,"finalDeltaValue",a),w(this,"deltaBehavior","increase"),w(this,"realDelta",a-o),this.assert(0<a-o,"expected "+c+" to increase","expected "+c+" to not increase")}function k(e,t,n){n&&w(this,"message",n);var o,r=w(this,"object"),i=w(this,"message"),s=w(this,"ssfi");new y(r,i,s,!0).is.a("function"),o=t?(new y(e,i,s,!0).to.have.property(t),e[t]):(new y(e,i,s,!0).is.a("function"),e()),new y(o,i,s,!0).is.a("number"),r();var a=null==t?e():e[t],c=null==t?o:"."+t;w(this,"deltaMsgObj",c),w(this,"initialDeltaValue",o),w(this,"finalDeltaValue",a),w(this,"deltaBehavior","decrease"),w(this,"realDelta",o-a),this.assert(a-o<0,"expected "+c+" to decrease","expected "+c+" to not decrease")}["to","be","been","is","and","has","have","with","that","which","at","of","same","but","does","still"].forEach(function(e){y.addProperty(e)}),y.addProperty("not",function(){w(this,"negate",!0)}),y.addProperty("deep",function(){w(this,"deep",!0)}),y.addProperty("nested",function(){w(this,"nested",!0)}),y.addProperty("own",function(){w(this,"own",!0)}),y.addProperty("ordered",function(){w(this,"ordered",!0)}),y.addProperty("any",function(){w(this,"any",!0),w(this,"all",!1)}),y.addProperty("all",function(){w(this,"all",!0),w(this,"any",!1)}),y.addChainableMethod("an",t),y.addChainableMethod("a",t),y.addChainableMethod("include",o,n),y.addChainableMethod("contain",o,n),y.addChainableMethod("contains",o,n),y.addChainableMethod("includes",o,n),y.addProperty("ok",function(){this.assert(w(this,"object"),"expected #{this} to be truthy","expected #{this} to be falsy")}),y.addProperty("true",function(){this.assert(!0===w(this,"object"),"expected #{this} to be true","expected #{this} to be false",!w(this,"negate"))}),y.addProperty("false",function(){this.assert(!1===w(this,"object"),"expected #{this} to be false","expected #{this} to be true",!!w(this,"negate"))}),y.addProperty("null",function(){this.assert(null===w(this,"object"),"expected #{this} to be null","expected #{this} not to be null")}),y.addProperty("undefined",function(){this.assert(void 0===w(this,"object"),"expected #{this} to be undefined","expected #{this} not to be undefined")}),y.addProperty("NaN",function(){this.assert(m.isNaN(w(this,"object")),"expected #{this} to be NaN","expected #{this} not to be NaN")}),y.addProperty("exist",function(){var e=w(this,"object");this.assert(null!=e,"expected #{this} to exist","expected #{this} to not exist")}),y.addProperty("empty",function(){var e,t=w(this,"object"),n=w(this,"ssfi"),o=w(this,"message");switch(o=o?o+": ":"",m.type(t).toLowerCase()){case"array":case"string":e=t.length;break;case"map":case"set":e=t.size;break;case"weakmap":case"weakset":throw new g(o+".empty was passed a weak collection",void 0,n);case"function":var r=o+".empty was passed a function "+m.getName(t);throw new g(r.trim(),void 0,n);default:if(t!==Object(t))throw new g(o+".empty was passed non-string primitive "+m.inspect(t),void 0,n);e=Object.keys(t).length}this.assert(0===e,"expected #{this} to be empty","expected #{this} not to be empty")}),y.addProperty("arguments",r),y.addProperty("Arguments",r),y.addMethod("equal",i),y.addMethod("equals",i),y.addMethod("eq",i),y.addMethod("eql",s),y.addMethod("eqls",s),y.addMethod("above",a),y.addMethod("gt",a),y.addMethod("greaterThan",a),y.addMethod("least",c),y.addMethod("gte",c),y.addMethod("below",u),y.addMethod("lt",u),y.addMethod("lessThan",u),y.addMethod("most",f),y.addMethod("lte",f),y.addMethod("within",function(e,t,n){n&&w(this,"message",n);var o,r=w(this,"object"),i=w(this,"doLength"),s=w(this,"message"),a=s?s+": ":"",c=w(this,"ssfi"),u=m.type(r).toLowerCase(),f=m.type(e).toLowerCase(),l=m.type(t).toLowerCase(),h=!0,d="date"===f&&"date"===l?e.toUTCString()+".."+t.toUTCString():e+".."+t;if(i&&"map"!==u&&"set"!==u&&new y(r,s,c,!0).to.have.property("length"),i||"date"!==u||"date"===f&&"date"===l)if("number"===f&&"number"===l||!i&&"number"!==u)if(i||"date"===u||"number"===u)h=!1;else{o=a+"expected "+("string"===u?"'"+r+"'":r)+" to be a number or a date"}else o=a+"the arguments to within must be numbers";else o=a+"the arguments to within must be dates";if(h)throw new g(o,void 0,c);if(i){var p,b="length";p="map"===u||"set"===u?(b="size",r.size):r.length,this.assert(e<=p&&p<=t,"expected #{this} to have a "+b+" within "+d,"expected #{this} to not have a "+b+" within "+d)}else this.assert(e<=r&&r<=t,"expected #{this} to be within "+d,"expected #{this} to not be within "+d)}),y.addMethod("instanceof",l),y.addMethod("instanceOf",l),y.addMethod("property",h),y.addMethod("ownProperty",d),y.addMethod("haveOwnProperty",d),y.addMethod("ownPropertyDescriptor",b),y.addMethod("haveOwnPropertyDescriptor",b),y.addChainableMethod("length",x,v),y.addChainableMethod("lengthOf",x,v),y.addMethod("match",O),y.addMethod("matches",O),y.addMethod("string",function(e,t){t&&w(this,"message",t);var n=w(this,"object"),o=w(this,"message"),r=w(this,"ssfi");new y(n,o,r,!0).is.a("string"),this.assert(~n.indexOf(e),"expected #{this} to contain "+m.inspect(e),"expected #{this} to not contain "+m.inspect(e))}),y.addMethod("keys",N),y.addMethod("key",N),y.addMethod("throw",S),y.addMethod("throws",S),y.addMethod("Throw",S),y.addMethod("respondTo",M),y.addMethod("respondsTo",M),y.addProperty("itself",function(){w(this,"itself",!0)}),y.addMethod("satisfy",j),y.addMethod("satisfies",j),y.addMethod("closeTo",A),y.addMethod("approximately",A),y.addMethod("members",function(e,t){t&&w(this,"message",t);var n=w(this,"object"),o=w(this,"message"),r=w(this,"ssfi");new y(n,o,r,!0).to.be.an("array"),new y(e,o,r,!0).to.be.an("array");var i,s,a,c=w(this,"contains"),u=w(this,"ordered");a=c?(s="expected #{this} to be "+(i=u?"an ordered superset":"a superset")+" of #{exp}","expected #{this} to not be "+i+" of #{exp}"):(s="expected #{this} to have the same "+(i=u?"ordered members":"members")+" as #{exp}","expected #{this} to not have the same "+i+" as #{exp}");var f=w(this,"deep")?m.eql:void 0;this.assert(function(e,o,r,i,s){if(!i){if(e.length!==o.length)return!1;o=o.slice()}return e.every(function(n,e){if(s)return r?r(n,o[e]):n===o[e];if(r)return o.some(function(e,t){return!!r(n,e)&&(i||o.splice(t,1),!0)});var t=o.indexOf(n);return-1!==t&&(i||o.splice(t,1),!0)})}(e,n,f,c,u),s,a,e,n,!0)}),y.addMethod("oneOf",function(e,t){t&&w(this,"message",t);var n=w(this,"object"),o=w(this,"message"),r=w(this,"ssfi");new y(e,o,r,!0).to.be.an("array"),this.assert(-1<e.indexOf(n),"expected #{this} to be one of #{exp}","expected #{this} to not be one of #{exp}",e,n)}),y.addMethod("change",P),y.addMethod("changes",P),y.addMethod("increase",E),y.addMethod("increases",E),y.addMethod("decrease",k),y.addMethod("decreases",k),y.addMethod("by",function(e,t){t&&w(this,"message",t);var n,o=w(this,"deltaMsgObj"),r=w(this,"initialDeltaValue"),i=w(this,"finalDeltaValue"),s=w(this,"deltaBehavior"),a=w(this,"realDelta");n="change"===s?Math.abs(i-r)===Math.abs(e):a===Math.abs(e),this.assert(n,"expected "+o+" to "+s+" by "+e,"expected "+o+" to not "+s+" by "+e)}),y.addProperty("extensible",function(){var e=w(this,"object"),t=e===Object(e)&&Object.isExtensible(e);this.assert(t,"expected #{this} to be extensible","expected #{this} to not be extensible")}),y.addProperty("sealed",function(){var e=w(this,"object"),t=e!==Object(e)||Object.isSealed(e);this.assert(t,"expected #{this} to be sealed","expected #{this} to not be sealed")}),y.addProperty("frozen",function(){var e=w(this,"object"),t=e!==Object(e)||Object.isFrozen(e);this.assert(t,"expected #{this} to be frozen","expected #{this} to not be frozen")}),y.addProperty("finite",function(e){var t=w(this,"object");this.assert("number"==typeof t&&isFinite(t),"expected #{this} to be a finite number","expected #{this} to not be a finite number")})}},function(e,t){
/*!
 * chai
 * Copyright(c) 2011-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
...
/*!
   * Aliases.
   */
function e(t,n){return f[n]=f[t],e}("isOk","ok")("isNotOk","notOk")("throws","throw")("throws","Throw")("isExtensible","extensible")("isNotExtensible","notExtensible")("isSealed","sealed")("isNotSealed","notSealed")("isFrozen","frozen")("isNotFrozen","notFrozen")("isEmpty","empty")("isNotEmpty","notEmpty")}},function(e,t,n){"use strict";e.exports=function(e,t,n){if(e.name!==t||"UNKNOWN"===e.name)return NaN;for(var o=e.version.split("."),r=0,i=o.length;r<i;r++)o[r]=parseInt(o[r],10);for(var s=n.split("."),a=0,c=s.length;a<c;a++)s[a]=parseInt(s[a],10);for(var u=0,f=o.length;u<f;u++){if(u>=s.length)return 1;if(o[u].length||isNaN(o[u])||s[u].length||isNaN(s[u]))return NaN;if(o[u]<s[u])return-1;if(o[u]>s[u])return 1}return o.length<s.length?-1:0}},function(e,t,n){"use strict";var o=n(39);e.exports=function(){var n={};return Object.defineProperties(n,{lt:{enumerable:!0,value:function(e,t){return o(n,e,t)<0}},lte:{enumerable:!0,value:function(e,t){return o(n,e,t)<=0}},gt:{enumerable:!0,value:function(e,t){return 0<o(n,e,t)}},gte:{enumerable:!0,value:function(e,t){return 0<=o(n,e,t)}},eq:{enumerable:!0,value:function(e,t){return 0===o(n,e,t)}},ne:{enumerable:!0,value:function(e,t){return 0!==o(n,e,t)}}}),n}},,,,,,function(e,t,n){e.exports=n(47)},function(e,t,n){"use strict";var o=n(15).expect,r=n(40);describe("create-comparable",function(){var e=r();e.name="MACOS",e.version="10.11.3";var t=r();t.name="UNKNOWN",t.version="10.11.3",describe(".lt",function(){it("Should return true when name is same and version is less",function(){o(e.lt("MACOS","10.11.4")).to.be.true,o(e.lt("MACOS","10.12.0")).to.be.true,o(e.lt("MACOS","11.1.0")).to.be.true}),it("Should return false when name is same and version is same",function(){o(e.lt("MACOS","10.11.3")).be.false}),it("Should return false when name is same and version is great",function(){o(e.lt("MACOS","10.11.2")).be.false,o(e.lt("MACOS","10.10.4")).be.false,o(e.lt("MACOS","9.12.4")).be.false}),it("Should return false when name is differnt",function(){o(e.lt("WINNT","10.11.4")).be.false,o(e.lt("LINUX","10.12.0")).be.false,o(e.lt("IPHONE","11.1.0")).be.false,o(e.lt("UNKNOWN","10.11.3")).be.false}),it("Should return false when name is UNKNOWN",function(){o(t.lt("UNKNOWN","10.11.4")).be.false}),it("Should return false when name is illegal format",function(){o(e.lt("MACOS","10.11.a")).be.false})}),describe(".lte",function(){it("Should return true when name is same and version is less",function(){o(e.lte("MACOS","10.11.4")).to.be.true,o(e.lte("MACOS","10.12.0")).to.be.true,o(e.lte("MACOS","11.1.0")).to.be.true}),it("Should return true when name is same and version is same",function(){o(e.lte("MACOS","10.11.3")).to.be.true}),it("Should return false when name is same and version is great",function(){o(e.lte("MACOS","10.11.2")).be.false,o(e.lte("MACOS","10.10.4")).be.false,o(e.lte("MACOS","9.12.4")).be.false}),it("Should return false when name is differnt",function(){o(e.lte("WINNT","10.11.4")).be.false,o(e.lte("LINUX","10.12.0")).be.false,o(e.lte("IPHONE","11.1.0")).be.false,o(e.lte("UNKNOWN","10.11.3")).be.false}),it("Should return false when name is UNKNOWN",function(){o(t.lte("UNKNOWN","10.11.4")).be.false}),it("Should return false when name is illegal format",function(){o(e.lte("MACOS","10.11.a")).be.false})}),describe(".gt",function(){it("Should return false when name is same and version is less",function(){o(e.gt("MACOS","10.11.4")).be.false,o(e.gt("MACOS","10.12.0")).be.false,o(e.gt("MACOS","11.1.0")).be.false}),it("Should return false when name is same and version is same",function(){o(e.gt("MACOS","10.11.3")).be.false}),it("Should return true when name is same and version is great",function(){o(e.gt("MACOS","10.11.2")).to.be.true,o(e.gt("MACOS","10.10.4")).to.be.true,o(e.gt("MACOS","9.12.4")).to.be.true}),it("Should return false when name is differnt",function(){o(e.gt("WINNT","10.11.4")).be.false,o(e.gt("LINUX","10.12.0")).be.false,o(e.gt("IPHONE","11.1.0")).be.false,o(e.gt("UNKNOWN","10.11.3")).be.false}),it("Should return false when name is UNKNOWN",function(){o(t.gt("UNKNOWN","10.11.4")).be.false}),it("Should return false when name is illegal format",function(){o(e.gt("MACOS","10.11.a")).be.false})}),describe(".gte",function(){it("Should return false when name is same and version is less",function(){o(e.gte("MACOS","10.11.4")).be.false,o(e.gte("MACOS","10.12.0")).be.false,o(e.gte("MACOS","11.1.0")).be.false}),it("Should return true when name is same and version is same",function(){o(e.gte("MACOS","10.11.3")).to.be.true}),it("Should return true when name is same and version is great",function(){o(e.gte("MACOS","10.11.2")).to.be.true,o(e.gte("MACOS","10.10.4")).to.be.true,o(e.gte("MACOS","9.12.4")).to.be.true}),it("Should return false when name is differnt",function(){o(e.gte("WINNT","10.11.4")).be.false,o(e.gte("LINUX","10.12.0")).be.false,o(e.gte("IPHONE","11.1.0")).be.false,o(e.gte("UNKNOWN","10.11.3")).be.false}),it("Should return false when name is UNKNOWN",function(){o(t.gte("UNKNOWN","10.11.4")).be.false}),it("Should return false when name is illegal format",function(){o(e.gte("MACOS","10.11.a")).be.false})}),describe(".eq",function(){it("Should return false when name is same and version is less",function(){o(e.eq("MACOS","10.11.4")).be.false,o(e.eq("MACOS","10.12.0")).be.false,o(e.eq("MACOS","11.1.0")).be.false}),it("Should return true when name is same and version is same",function(){o(e.eq("MACOS","10.11.3")).to.be.true}),it("Should return false when name is same and version is great",function(){o(e.eq("MACOS","10.11.2")).be.false,o(e.eq("MACOS","10.10.4")).be.false,o(e.eq("MACOS","9.12.4")).be.false}),it("Should return false when name is differnt",function(){o(e.eq("WINNT","10.11.4")).be.false,o(e.eq("LINUX","10.12.0")).be.false,o(e.eq("IPHONE","11.1.0")).be.false,o(e.eq("UNKNOWN","10.11.3")).be.false}),it("Should return false when name is UNKNOWN",function(){o(t.eq("UNKNOWN","10.11.4")).be.false}),it("Should return false when name is illegal format",function(){o(e.eq("MACOS","10.11.a")).be.false})}),describe(".ne",function(){it("Should return true when name is same and version is less",function(){o(e.ne("MACOS","10.11.4")).to.be.true,o(e.ne("MACOS","10.12.0")).to.be.true,o(e.ne("MACOS","11.1.0")).to.be.true}),it("Should return false when name is same and version is same",function(){o(e.ne("MACOS","10.11.3")).be.false}),it("Should return false when name is same and version is great",function(){o(e.ne("MACOS","10.11.2")).to.be.true,o(e.ne("MACOS","10.10.4")).to.be.true,o(e.ne("MACOS","9.12.4")).to.be.true}),it("Should return false when name is differnt",function(){o(e.ne("WINNT","10.11.4")).to.be.true,o(e.ne("LINUX","10.12.0")).to.be.true,o(e.ne("IPHONE","11.1.0")).to.be.true,o(e.ne("UNKNOWN","10.11.3")).to.be.true}),it("Should return false when name is UNKNOWN",function(){o(t.ne("UNKNOWN","10.11.4")).to.be.true}),it("Should return false when name is illegal format",function(){o(e.ne("MACOS","10.11.a")).to.be.true})})})}]);